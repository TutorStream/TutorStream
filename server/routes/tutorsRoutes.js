...
tutorsRouter.get('/', usersControllers.getTutors);

// tutorsRouter.get('/tutors/selectTutors', usersControllers.getTutors);
tutorsRouter.get('/selectTutors', usersControllers.getTutors);

// tutorsRouter.get('/tutors/:id', usersControllers.getTutorProfile);
tutorsRouter.get('/:id', usersControllers.getTutorProfile);

// tutorsRouter.post('/tutors/:id', usersControllers.addOrUpdateTutor);
tutorsRouter.post('/:id', usersControllers.addOrUpdateTutor);
