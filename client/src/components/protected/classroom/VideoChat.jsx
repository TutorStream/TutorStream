...
class VideoChat extends Component {
    ...
    render() {
       ...
       return(
        ...
        <iframe src={`https://tokbox.com/embed/embed/ot-embed.js?embedId=8544449c-6e81-4eed-a738-3ae823ba780e&room=${this.state.room_id}&iframe=true`} width="800px" height="640px" allowFullScreen="true"  allow="microphone; camera" >
        </iframe>
        <br />
