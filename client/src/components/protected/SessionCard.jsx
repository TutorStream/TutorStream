      ...
      <Card>
        <CardBody>
          ...
          <CardSubtitle>
            ...
            Time: {Number(props.session.time.slice(0, 2)) < 12 ? props.session.time.slice(0, 5) + ' a.m.' : String(Number(props.session.time.slice(0, 2)) - 12) + props.session.time.slice(2, 5) + ' p.m.'}
          </CardSubtitle>
